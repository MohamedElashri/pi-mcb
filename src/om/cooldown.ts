 ...
 * Cooldowns are persisted to `~/.pi/agent/pi-mcb/pi-mcb-cooldown.json`.
 */

/**
 * Cooldown persistence for retryable API errors.
 *
 * Created by pi-mcb-om. Records per-model cooldowns to disk so rate-limited
 ...
 * - Cooldowns survive pi restarts via pi-mcb/pi-mcb-cooldown.json.
 */
...
const COOLDOWN_FILE = "pi-mcb-cooldown.json";
