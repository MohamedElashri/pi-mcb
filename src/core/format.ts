...
export const RECALL_NOTE =
  ...
  "Details not captured here — exact code, error messages, file paths — are only recoverable from session history. " +
  "To search it, run `/mcb-recall <query>`; the agent can use its `recall` tool. Do not redo work already completed.";
